	...
	return (
		<InspectorControls>
			...
			>
				...
				<Styler
					clientId={ clientId }
					label={ __( 'Billing Address Title', 'shop-press' ) }
				...
				<Styler
					clientId={ clientId }
					label={ __( 'Billing Address Edit Link', 'shop-press' ) }
				...
				<Styler
					clientId={ clientId }
					label={ __( 'Billing Address Addresses', 'shop-press' ) }
				...
				<Styler
					clientId={ clientId }
					label={ __( 'Shipping Address Title', 'shop-press' ) }
				...
				<Styler
					clientId={ clientId }
					label={ __( 'Shipping Address Edit Link', 'shop-press' ) }
				...
				<Styler
					clientId={ clientId }
					label={ __( 'Shipping Address Addresses', 'shop-press' ) }
...
const Edit = ( props ) => {
	...
	return (
		<div { ...blockProps }>
			...
			<Wrapper { ...props }>
				<ServerSideRender
					block="shop-press/my-account-addresses"
					attributes={ attributes }
				/>
			</Wrapper>
		</div>
