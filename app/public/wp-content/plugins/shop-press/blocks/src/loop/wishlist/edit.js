...
const Inspector = ( { attributes, setAttributes, clientId } ) => {
	const { icon, icon_pos, overlay, show_label } = attributes;
		...
		<InspectorControls>
			...
			>
				...
				<Styler
					...
					selector=".sp-wishlist-loop .sp-wishlist-button"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-loop .sp-wishlist-icon"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-loop .sp-wishlist-icon i.sp-icon"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-loop[data-status='yes'] .sp-wishlist-icon i.sp-icon"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-loop .sp-wishlist-label"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-loop[data-status='yes'] .sp-wishlist-label"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
...
const Edit = ( props ) => {
	...
	return (
		<div { ...blockProps }>
			...
			<Wrapper { ...props }>
				<ServerSideRender
					block="shop-press/loop-wishlist"
					attributes={ attributes }
				/>
			</Wrapper>
		</div>
