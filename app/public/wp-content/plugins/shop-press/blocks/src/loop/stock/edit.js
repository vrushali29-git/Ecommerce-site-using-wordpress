	...
	return (
		<InspectorControls>
			...
			<PanelBody title={ __( 'Styles', 'shop-press' ) }>
				...
				<Styler
					clientId={ clientId }
					label={ __( 'Availability', 'shop-press' ) }
		...
		<div { ...blockProps }>
			...
			<Wrapper { ...props }>
				<p className="sp-product-stock">
					<span className="sp-stock-label">{ label }</span>
					<span className="sp-stock-availability">Out of stock</span>
				</p>
			</Wrapper>
		</div>
	);
