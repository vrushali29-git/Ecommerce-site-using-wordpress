		...
		<InspectorControls>
			...
			>
				...
				<Styler
					...
					selector=".sp-wishlist .sp-wishlist-button"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-button .sp-wishlist-label"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist[data-status='yes'] .sp-wishlist-button .sp-wishlist-label"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-button .sp-wishlist-icon"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist-button .sp-wishlist-icon i.sp-icon"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
				...
				<Styler
					...
					selector=".sp-wishlist[data-status='yes'] .sp-wishlist-button .sp-wishlist-icon i.sp-icon"
					wrapper={ `.${ attributes[ 'wrapperID' ] }` }
					attributes={ attributes }
					setAttributes={ setAttributes }
				/>
...
const Edit = ( props ) => {
	...
	return (
		<div { ...blockProps }>
			...
			<Wrapper { ...props }>
				<ServerSideRender
					block="shop-press/product-wishlist"
					attributes={ attributes }
				/>
			</Wrapper>
		</div>
